...
app.addHook('onRequest', async (req, reply) => {
  ...
  if (req.url.startsWith('/v1/spotify/auth') || 
      req.url.startsWith('/v1/spotify/callback') ||
      req.url.startsWith('/v1/spotify/customer-auth') ||
      req.url.startsWith('/v1/spotify/customer-callback')) return;
